...
<body>
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required>
            ...
            <div class="form-group"><br>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <br>
                 <!-- <span>Don't yet account?</span> <a href="mentorform.php" style="color: #4e8fd1;" id="sign"> Sign Up</a> -->
            </div>
        </form>
    </div>
...
<?php
	...
	if(isset($_POST['login']))
	{
		...
		$log=mysqli_query($con,"select * from mentor where email='$email' and password='$password'") or die(mysqli_error($con));
		...
		if(mysqli_num_rows($log)>0){
            ...
            echo "window.location.href = 'mentorhome.php?mentorId=$mId&year=$year';";
			echo "</script>";
            ...
            echo "window.location.href = 'mentor_login.php?mentorId=$mId&year=$year';";
			echo "</script>";
