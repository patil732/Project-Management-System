...
<body>
    ...
    ?>
    <header>
        <span style="font-size:20px"><b>Welcome <?php
               $selectQuery = "SELECT * FROM `mentor` WHERE id = $mentorId ";
                ...
                echo $rowM['firstname'].' '.$rowM['lastname']?> - View Progress</b></span><br>
    </header>
            ...
            <div style="padding:20px;margin-bottom:200px;">
                <div>
                    <div style="float: right;">
                        ...
                        <span><i class="fa fa-square" style="color:white;border:1px solid black"></i> Pending</span>
