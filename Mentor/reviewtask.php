...
if(isset($_POST['approved'])) {
    ...
    //$update = mysqli_query($con, "UPDATE taskstatus SET remark='approved', evaluation='' WHERE id = $wId") or die(mysqli_error($con));

        echo "<script>";
        echo "window.location.href = 'evaluation.php?mentorId=$mentorId&year=$year&groupNo=$groupNo&weekId=$weekId&wId=$wId&studentId=$studentId';";
        echo "</script>";
