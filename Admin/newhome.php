...
<body>
    ...
    <div id="container">
        ...
        if(isset($_GET['mname'])) {
            ...
            $mentorNamesQuery = "SELECT id, CONCAT(firstname, ' ', lastname) AS mentorName FROM mentor";
            $mentorNamesResult = mysqli_query($con, $mentorNamesQuery);
        }?>
        ...
        if(isset($_GET['pname'])) {
            ...
            if($pidd==0){
                ...
                echo '<option value="'. $pidd.'">Project details Added group</option>';
            }
            else{
                echo '<option value="'. $pidd.'">Project details Not Added groups</option>';
            }
        }
        ?>
                            <option value="Yes">All Groups</option>
                            <option value="1">Project details Added group</option>
                            <option value="2">Project details Not Added groups</option>
