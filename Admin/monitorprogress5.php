...
<head>
    ...
    margin-bottom: 150px;
        ...
        #groupTable tr:nth-child(even){background-color: #f0efff;}
...
<body>
    <header>
         <h2>Monitor Progress Semestor 5 - Welcome Admin</h2>
    </header>
                            ...
                            <tr>
                                ...
                                <td><?php
                                                ...
                                                echo $group['projecttitle']; 
                                                    ...
                                                    ?>
                                                    <a href="addproject.php?year=<?php echo $year ?>&g_id=<?php echo $group['id']; ?>">Add Project Details</a> 
                                                    <?php 
                                                }?> </td>
                                <td class="mentor-name"><?php 
                                            ...
                                            if($group['mentorid'] == 0)
                                            {  ?> 
                                                <a href="assignmentor.php?g_id=<?php echo $group['groupno']; ?>&year=<?php echo $year; ?>">assign mentor</a>
            ...
            FROM timeline where id=$id";
                                    ...
                                    if ($currentDate >= $startDate && $currentDate <= $endDate) {
                                        ...
                                        if (mysqli_num_rows($CoResult) > 0) {
                                            ...
                                            ?><th style=" background-color:blue;border-right:1px solid black;" class="week-th" data-week="<?php echo $wNumber; ?>"
                                                data-details="Week <?php echo $wNumber; ?> Details"
                                                data-startdate="<?php echo $sDate; ?>" data-enddate="<?php echo $eDate; ?>"
                                        ...
                                        if (mysqli_num_rows($CoResult) > 0) {
                                            ...
                                            ?>
                                            <th style="border:1px solid black;color:black" class="week-th" data-week="<?php echo $wNumber; ?>"
                                                data-details="Week <?php echo $wNumber; ?> Details"
                                                data-startdate="<?php echo $sDate; ?>" data-enddate="<?php echo $eDate; ?>"
                                                data-activityplan="<?php echo $week['activityplan']; ?>">
                                                <?php echo $wNumber; ?>
    ...
    document.getElementById('mentorFilter').addEventListener('change', function() {
        ...
        for (var i = 1; i < tableRows.length; i++) {
            var mentorCell = tableRows[i].getElementsByTagName('td')[2]; // Get mentor name cell
